...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='synthia2cs_2nd', help='name of the experiment. It decides where to store samples and models')  # gta2cs_1080_512 synthia2cs_2nd
        ...
        parser.add_argument('--load_size', type=int, default=760, help='scale images to this size')
