...
def parse_args():
    ...
    parser.add_argument(
        '--name', type=str, default='', help='Name of the cut')
...
def main():
    ...
    model = build_train_model(cfg, train_cfg=cfg.get('train_cfg'),
    ...
    checkpoint_cut = load_checkpoint(
        model.cut_model.netG,
        'cut_checkpoints/gta2cs_daformer_cut_simpconv_s_netG_79000.pth',
        map_location='cpu',
        revise_keys=[(r'^module\.', '')])
